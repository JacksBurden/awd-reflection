const goalMap = {
  ...
  negotiation: { name: 'Negotiation', description: 'Students negotiate their own writing goals and audience expectations regarding conventions of genre, medium, and situation.',
    tips: "Keep your audience in mind while writing. Doing so will lead to a tone appropriate for your genre, medium, and situation. Picture yourself in your reader’s shoes."},
  stance: { name: 'Stance', description: 'Students formulate and articulate a stance through and in their writing.',
    tips: "Make sure you have a strong position before beginning to write. Establish your stance early on with a strong thesis that is backed up with details in your body paragraphs."},
  ...
  reading: { name: 'Reading', description: 'Students practice critical reading strategies.',
    tips: "When doing peer review, read critically with attention to rubric guidelines and the learning goals. When completing any class reading assignments, pay close attention for the learning goals and prominence of the rhetorical situation. This awareness will help you revise your own work."},
